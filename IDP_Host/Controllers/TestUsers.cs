...
namespace IDP.Controllers
{
    public class TestUsers
    {
        ...
        {
            new TestUser{SubjectId = "1", Username = "eva", Password = "password",
                Claims =
                {
                    new Claim(JwtClaimTypes.Name, "Eva Doe"),
                    new Claim(JwtClaimTypes.GivenName, "Eva"),
                    new Claim(JwtClaimTypes.FamilyName, "Doe"),
                    new Claim(JwtClaimTypes.Email, "evadoe@email.com"),
